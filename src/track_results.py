...
rows = []
for exp in track(os.listdir("DCASE2025feature/checkpoints"), description="Scanning experiments"):
    ckpt_file = os.path.join("DCASE2025feature/checkpoints", exp, "best_model.pth")
